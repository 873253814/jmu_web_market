...
<%@page import="jmu_web.market.book.dao.BookDAO"%>
<%@page import="jmu_web.market.book.dao.impl.BookDAOImpl"%>
<%@page import="jmu_web.market.book.entity.Book"%>
                   ...
                   <form method="post" action="">
                    <table id="my_order" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td><span class="label bg-yellow"><%=book.getPrice() %></span></td>
