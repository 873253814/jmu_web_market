        ...
        <div class="box box-primary">
          ...
          <form class="form-horizontal">
            <div class="box-body">
              ...
              <div class="form-group">
                <div class="col-sm-10">
                  <input type="password" class="form-control" name="cnpassword" id="cnpassword" placeholder="Confirm New Password">
                </div>
              </div>
            </div>
            <!-- /.box-body -->
...
<!--两次新密码输入比较 -->
$(function(){
	$(".qqueding").click(function(){
		var p1 = $("#npassword").val();
		var p2 = $("#cnpassword").val();
		if(!p1){
			alert("密码不能为空！");
		}elae if(p1!=p2){
			...
			alert("密码修改成功");
			$("#tanchukuang").hide();
			//https://blog.csdn.net/zhang150114/article/details/88876630
		}
	})
}
		)
