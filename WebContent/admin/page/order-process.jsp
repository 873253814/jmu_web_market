    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col my_info">
          ...
          <b>当前订单状态：</b>${order.sta}
          <!-- radio -->
          <div class="form-group my_formgroup">
            <form action="../../OrderProcessServlet">
            <div class="radio my_radio">
              <label>
                <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" disabled>待处理(Paid)
              </label>
            </div>
            <div class="radio my_radio">
              <label>
                <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2" checked>待处理(InHand)
              </label>
            </div>
            <div class="radio my_radio">
              <label>
                <input type="radio" name="optionsRadios" id="optionsRadios3" value="option3">待处理(Shipped)
              </label>
            </div>
            <div class="radio my_radio">
              <label>
                <input type="radio" name="optionsRadios" id="optionsRadios4" value="option3" disabled>待处理(Received)
              <c:out value=" $("input[name='optionsRadios']:checked").val()"></c:out>
              </label>
            </div>
            <div class="radio my_radio">
