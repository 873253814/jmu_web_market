                  ...
                  <div class="box-body">
                    <table id="my_order" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <c:choose>
                        	<c:when test="${order.sta == 'Paid'}">
                           		<c:out value="待处理"></c:out>
                       		</c:when>
                       		<c:when test="${order.sta == 'InHand'}">
                           		<c:out value="处理中"></c:out>
                       		</c:when>
                       		<c:when test="${order.sta == 'Shipped'}">
                        ...
                        <td>${order.sta}---${order.placed}</td>
                        <td>${order.payment}</td>
                        <td><a href="OrderDetailServlet?order_id=${order.orderId}">查看</a>丨<a href="OrderProcessServlet?order_id=${order.orderId}">处理</a></td>
                      </tr>
                      </c:forEach>
                      </tbody>
                      <tfoot>
