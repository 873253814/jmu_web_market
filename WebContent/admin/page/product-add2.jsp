  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <div class="box box-primary">
        ...
        <form class="form-horizontal" id="fm-add" role="form" action="" method="" enctype="multipart/form-data">
          <div class="box-body">
            <div class="form-group">
              <div class="col-sm-10 my-input">
                <input type="text" class="form-control" name="isbn" id="isbn" value="666333" placeholder="图书编号">
              </div> 
              <div class="col-sm-10 my-input">
                <input type="text" class="form-control" name="title" id="title" value="深入学习 C++" placeholder="书名">
              </div>
              <div class="col-sm-10 my-input">
                <input type="text" class="form-control" name="author" id="author" value="奥德赛" placeholder="作者">
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-10 my-input">
                <input type="text" class="form-control" name="price" id="price" value="55" placeholder="价格">
              </div>
              <div class="col-sm-10 my-input">
                <input type="text" class="form-control" name="pages" id="pages" value="250" placeholder="页数">
              </div>
              <div class="col-sm-10 my-input">
                <input type="text" class="form-control" name="words" id="words"  value="50000" placeholder="字数">
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-10 my-input">
                <input type="text" class="form-control" name="press" id="press"  value="北大"  placeholder="出版社">
              </div>
              <div class="col-sm-10 my-input">
                <input type="text" class="form-control" name="edition" id="edition" value="3" placeholder="版次">
              </div>
              <div class="col-sm-10 my-input">
                <input type="text" class="form-control" name="published" id="published" value="2018-10-8" placeholder="出版日期">
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-10 my-input">
                <select class="form-control" name="format" id="format">
                  ...
                  <option value="16开" >16开</option>
        					<option value="32开"  selected="selected">32开</option>
              ...
              <div class="col-sm-10 my-input">
                <select class="form-control" name="packaging" id="packaging">
                  <option>包装</option>
                  <option value="平装" selected="selected">平装</option>
              ...
              <div class="col-sm-10 my-input">
                <select class="form-control" name="form" id="form">
                  <option>用纸</option>
                  <option value="胶版纸" selected="selected">胶版纸</option>
...
/*$('#bt-submit').click(function(){
    ...
    var formData = $('#fm-add').serialize();  //不能完成文件上传
