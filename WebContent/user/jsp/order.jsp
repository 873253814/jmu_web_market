<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <%@ page import="jmu_web.market.order.dao.impl.*"%>
<%@ page import="jmu_web.market.order.*"%>
<%@ page import="jmu_web.market.order.dao.*"%>
...
<head lang="en">
	...
	List<UserOrder> orderList = dao.getOrderBookById(sid);
	%>
        ...
        <div class="rightsidebar_box rt">
            ...
            <div id="orderItem">
              ...
              <div id="orderItem_detail">
                  <ul>
                      <li class="product">
                          <b><a href="#"><img src="../img/goods/<%=o.getProduct() %>/detail1.jpg" /></a></b>
                      ...
                      <li class="sale_support">
                          ...
                          我要维权
                          <br/>
                          <a href="../../DeleteOrderServlet?sid=<%=sid%>&orderId=<%=o.getOrderId()%>">删除订单</a>
                      </li>
                      <li class=" payments_received">
                          ￥<%=o.getTotal() %>
                      </li>
                      <li class="trading_status">
                          <img src="../img/myOrder/car.png" alt=""/><%=o.getSta() %>
                          <br/>
                          <a href="order-info.html">订单详情</a>
                      </li>
                      <li class="operate">
                          <a href="../../UpdateOrderServlet?sid=<%=sid%>&orderId=<%=o.getOrderId()%>">确认收货</a>
                      </li>
                  </ul>
              </div>
              <%} %>
