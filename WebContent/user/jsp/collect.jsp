<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="jmu_web.market.collect.*" %>
<%@page import="jmu_web.market.collect.dao.*" %>
<%@page import="jmu_web.market.collect.dao.impl.*" %>
...
<head>
    ...
    <%
		...
		List<Collect> collectBookList = dao.getCollectBookById(sid);
    %>
</head>
<body>
<!-- 页面顶部-->
    ...
    <form  name="" action="" method="post" >
        <section id="section" >
            ...
            <div id="box" >
		        ...
		        <div id="content_box" >
					<%for(Collect c:collectBookList){ %>
                    <div class="lf" id="d1">
                        <div class="img">
                            <a href="detail.jsp?isbn=<%=c.getProduct()%>">
                            	<img src="../img/goods/<%=c.getProduct() %>/collect.jpg" alt=""/>
                            </a>
                        </div>
                        <div class="describe">
                            <p><%=c.getTitle() %></p>
                            <span class="price"><b>￥</b><span class="priceContent"><%=c.getPrice() %></span></span>
                            <span class="addCart"><a href="detail.jsp?isbn=<%=c.getProduct()%>">查看</a>&nbsp;<a href="../../DeleteCollectServlet?product=<%=c.getProduct()%>&userId=<%=sid%>">删除</a></span>
